...
Modified By RileyBeeRBLX And Fixed By Riley

I use this for v3 also i give credit to TheRealX_ORA
...
NotifyLib.prompt('Riley Aim Lock V3', 'Modified By RileyBeeRBLX', 5)
...
if isTouchEnabled then
    ...
    NotifyLib.prompt('Mobile Device Detected', 'Loading The Riley Aim Lock Tool!', 5)
    ...
    NotifyLib.prompt('Riley Aim Lock Tool', 'Riley Aim Lock Tool Has Successfully Loaded!', 5)
    
elseif isMouseEnabled and isMouseEnabled then
    NotifyLib.prompt('PC Device Detected', 'smite em with v button', 5)
    
elseif isGamepadEnabled and isTouchEnabled then
    
    NotifyLib.prompt('Controller And Mobile Device Detected', 'Loading Riley Aim Lock Tool..', 5)
    ...
    NotifyLib.prompt('Controller And Mobile V Tool', 'Loading Riley Aim Lock Tool!', 5)

elseif isMouseEnabled and isMouseEnabled and isTouchEnabled then
    
    NotifyLib.prompt('Hybird Mobile Device Detected', 'Loading Riley Aim Lock Tool', 5)
    ...
    NotifyLib.prompt('Loading Riley Aim Lock Tool', 'Riley Aim Lock Tool Has Successfully Loaded!', 5)
end
        ...
        if enabled == true then
            ...
            if Settings.rewrittenmain.NOTIF == true then
                ...
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Riley Aim Lock V3",
                    Text = "You Let Him Live:"..tostring(Plr.Character.Humanoid.DisplayName),
                    Duration = 1.5
                })
            end
        else
...
NotifyLib.prompt('Riley Aim Lock V3', 'Loaded Riley Aim Lock V3!', 5)

--[[
da hood aim lock v3? Yippie a aimlock
]]--
